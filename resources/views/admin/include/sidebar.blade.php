<div class="w-full sm:w-1/4 p-6 bg-white border-b border-gray-200">
    ...
    <ul  style="list-style-type:disc;">
        <li class="text-xl pb-2">Class
            <ol class="text-sm pt-2 ">
                <li><a class="bg-green-700 m-6 p-2" href="{{route('groups.create')}}">Create Class</a></li>
                <br>
                <li><a class="bg-green-400 m-6 p-2 px-5" href="{{route('groups.index')}}">All Class</a></li>
